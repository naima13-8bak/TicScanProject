...
<form action="{{route('gestionImages.update', [ 'gestionImage' => $image->id])}}" method="post" class="formm">
   @csrf
   @method('PUT')
               ...
               <div>
                ...
                <div class="col-12">
                  <fieldset class="form-group">
                    <select name="motif_id" value="{{old('image',$image->image)}}">
...
<div class="col-12">
                  <fieldset class="form-group">
                               <input  type="file" class="form-control" id="image" name="image"  value="{{old('image',$image->image)}}"/>
                               <label style="background-color: ;color:;" class="input-group-text" for="image">Télecharger</label>
