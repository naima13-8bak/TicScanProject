...
<form action="{{route('gestionMotifs.update', [ 'gestionMotif' => $motif->id])}}" method="post" class="formm">
   @csrf
   @method('PUT')
               ...
               <div>
                ...
                <div class="col-12">
                  <fieldset class="form-group">
                    ...
                    <input type="text" class="form-control" name="nom" id="nom"  value="{{old('nom',$motif->nom)}}">
                 </fieldset>
                </div>
                ...
                <div class="col-12">
                    <fieldset class="form-group">
                      ...
                      <input type="text" class="form-control" name="description" id="description"  value="{{old('description',$motif->description)}}">
                   </fieldset>
                  </div>
